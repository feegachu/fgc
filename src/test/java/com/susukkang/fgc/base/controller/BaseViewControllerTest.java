...
class BaseViewControllerTest {
    ...
    void 로그인한_전체_역할은_수수료_항목을_조회할_수_있다(String roleCode) throws Exception {
        ...
        mockMvc.perform(get("/base").with(user(principal(roleCode))))
                ...
                .andExpect(content().string(containsString("지급/차감")))
                .andExpect(content().string(containsString("status-badge-success")))
                .andExpect(content().string(containsString(">지급</span>")))
                .andExpect(content().string(containsString(">모집수수료</td>")))
                .andExpect(content().string(containsString("적용 시작일")))
                .andExpect(content().string(containsString("적용 종료일")))
                ...
                .andExpect(content().string(containsString("data-base-form=\"commission-item\"")))
                .andExpect(content().string(containsString("data-base-body=\"commission-item\"")))
